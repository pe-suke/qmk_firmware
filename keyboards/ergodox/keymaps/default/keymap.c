 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|   "  | ESC  | LGui |Gr/ALT|                                       |   [  |   ]  |  Up  |  Dn  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,--------------.
 *                                        | App  |ESC   |       | LEFT | RIGHT  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // right hand
        KC_7,        KC_8,   KC_9,   KC_0,   KC_MINS,  JA_HAT,         JA_ENVL,
        ...
        KC_B,        KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          SFT_T(JA_ENUN),
                             JA_LBRC,JA_RBRC,KC_UP,  KC_DOWN,          LT(SYMB, KC_NO),
             KC_LEFT,        KC_RGHT,
             KC_UP,
 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |Ctrl    |HOME  |Down  |Right |      |  H   |------|           |------|Left  |Down  |Up    |Right |  {   |  }     |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |Shift   |MHEN  |HENK  |KANA  |      |      |      |           |      |      |M(1)  |Past  |Copy  |      |Shift   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |Win+L |      |      |      | DEL  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[META] = KEYMAP(
       ...
       KC_LCTL, KC_HOME, KC_DOWN, KC_RGHT, KC_MYCM, KC_H,
       KC_LSFT, KC_MHEN, KC_HENK, KC_KANA, KC_CALC, KC_MAIL, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                           KC_TRNS, KC_TRNS,
                                                    KC_TRNS,
